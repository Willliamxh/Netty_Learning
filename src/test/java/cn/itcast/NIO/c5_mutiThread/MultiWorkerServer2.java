 ...
 */
@Slf4j
public class MultiWorkerServer2 {
        ...
        while (true){
            ...
            while (iterator.hasNext()){
                ...
                if(key.isAcceptable()){
                    ...
                    workers[(index.getAndIncrement())%workers.length].init(socketChannel);// 初始化 worker 被boss线程调用
    ...
    static class worker implements Runnable{
        ...
        public void init(SocketChannel socketChannel) throws Exception {
            ...
            // 然后抛出异常
            selector.wakeup();
            log.debug("socketChannel.register");
            socketChannel.register(selector,SelectionKey.OP_READ);
            log.debug(" socketChannel.register end");
